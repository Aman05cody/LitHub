...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("https://lithub-3d2k.onrender.com/user/signup", userInfo)
      .then((res) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className="mt-4 space-y-2">
                ...
                <input
                  ...
                  className="w-80 px-3 py-1 border rounded-md outline-none bg-white text-black dark:bg-slate-700 dark:text-white dark:border-gray-600"
